...
/**
 * Allows the player to fight an enemy until either Action>=3, Floor==Dungeon, or Health<0
 */
		...
		while (EnemyHP > 0) {
			...
			if (Action == 2) {// Allows the player to use potions they have collected.
				System.out.println("What item would you like to use? You have " + HealthPotion + " health potions and "
						+ PhysAttackPotion + " Attack potions. (1=Health Potion, 2=Attack Potion, 3 or higher=BACK)");
